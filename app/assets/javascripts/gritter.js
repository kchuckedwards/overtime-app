...
(function($) {
  ...
  */
  var gritter_item;
  var gritter_content =
    '[[close]][[image]]<div class="[[class_name]]"><span class="gritter-title">[[username]]</span><p>[[text]]</p></div><div style="clear:both"></div>';
  if (GritterModernizr.borderradius && GritterModernizr.rgba) {
    gritter_item =
      '<div class="gritter-item gritter-css3">' + gritter_content + '</div>';
  } else {
    gritter_item =
      '<div class="gritter-top"></div><div class="gritter-item gritter-css2">' +
      gritter_content +
  ...
  */
  var Gritter = {
    ...
    _tpl_item:
      '<div id="gritter-item-[[number]]" class="gritter-item-wrapper [[item_class]]" style="display:none">' +
      gritter_item +
      '</div>',
